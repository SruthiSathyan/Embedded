  ...
  if(eeproRet==HAL_OK)
  {
	writeToEEPROM(&byteArrayofStructureA, startingMemoryAddress1, size1);
 	...
 	writeToEEPROM(&byteArrayofStructureC, startingMemoryAddress3, size3);
  	...
  	readFromEEPROM(information, startingMemoryAddress1,size1);

  	readFromEEPROM(information, startingMemoryAddress2,size2);

  	readFromEEPROM(information, startingMemoryAddress3,size3);
  	...
  	memcpy(&resultA, information, sizeof(StructureA));
  	memcpy(&resultB, information, sizeof(StructureB));
